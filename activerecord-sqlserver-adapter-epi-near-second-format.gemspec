...
Gem::Specification.new do |spec|
  spec.name          = "activerecord-sqlserver-adapter-epi-near-second-format"
  ...
  spec.homepage      = "https://github.com/eng-jaime-santos/activerecord-sqlserver-adapter-epi-near-second-format"
